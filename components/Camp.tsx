...
const Camp = () => {
  return (
    <section className='flexCenter 2xl:max-container relative  flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
        ...
        <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
            <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 lg:py-20 relative w-full overflow-hidden rounded-3xl">
                ...
                <p className="regular-14 xl:regular-16 mt-5 text-white">
                    ...
                    Tht's why we are here for those of you who want to start an adventure
                </p>
                <Image
                    src="/quote.svg"
                    alt="camp-2"
