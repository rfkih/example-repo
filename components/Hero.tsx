...
const Hero = () => {
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:28 lg:py-20 xl:flex-row '>
        ...
        <div className='  relative z-20 flex flex-1 flex-col xl:w-1/2'>
            ...
            <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
                We want to be on each of yout journeys seeking the satisfaction of seeing the incorruptible beauty of nature. 
